                ...
                public static boolean checkSyntax (String entTokens)
                {
                    ...
                    for (int i = 0; i < word.length; i++) {
                        switch (j) {
                            ...
                            //Assignment Operator
                            case 'c':
                                if (word[i].contains("<assignment_operator>")) {
                                    j = 'd';
                                } else {
                                    return false;
                                }
